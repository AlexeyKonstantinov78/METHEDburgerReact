...
import logo_o from '../../assets/img/logo-o.svg';
  ...
  <footer className={style.footer}>
    <Container>
      <div className={style.footer__content}>
        <img className={style.footer__logo} src={logo_o} alt='Логотип YourMeal' />

        <address className={style.footer__address}>
          <div className={style.footer__contact}>
            <h2 className={style.footer__title}>Номер для заказа</h2>

            <a className={style.footer__phone} href='tel:+79999999999'>
              <svg
                width='24'
                height='24'
                viewBox='0 0 24 24'
        ...
        <div className={style.footer__development}>
          ...
          <p>
            Developer:{' '}
            <a href='mailto:info@alekseykonstantinov.ru'>Aleksey Konstantinov</a>
          </p>
        </div>
      </div>
    </Container>
