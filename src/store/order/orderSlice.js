...
import { calcTotals } from '../../utils/calcTotal';
  ...
  reducers: {
    addProduct: (state, action) => {
      ...
      if (productOrderList) {
        ...
        [state.totalCount, state.totalPrice] = calcTotals(state.orderGoods);
      } else {
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(orderRequestAsync.fulfilled, (state, action) => {
        ...
        //   0
        // );
        [state.totalCount, state.totalPrice] = calcTotals(orderGoods);
      })
